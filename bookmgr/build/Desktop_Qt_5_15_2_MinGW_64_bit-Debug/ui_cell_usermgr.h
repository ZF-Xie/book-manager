...
public:
    ...
    void setupUi(QWidget *Cell_UserMgr)
    {
        ...
        gridLayout_2->addWidget(le_search, 1, 3, 1, 1);
        ...
        gridLayout_2->addWidget(btn_del, 1, 2, 1, 1);
        ...
        gridLayout_2->addWidget(btn_change, 1, 1, 1, 1);
    ...
    void retranslateUi(QWidget *Cell_UserMgr)
    {
        ...
        btn_change->setText(QCoreApplication::translate("Cell_UserMgr", "\344\277\256\346\224\271\347\224\250\346\210\267", nullptr));
    } // retranslateUi
