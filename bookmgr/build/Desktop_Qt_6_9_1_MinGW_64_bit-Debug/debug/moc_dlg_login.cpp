...
namespace {
struct qt_meta_tag_ZN9Dlg_LoginE_t {};
} // unnamed namespace

template <> constexpr inline auto Dlg_Login::qt_create_metaobjectdata<qt_meta_tag_ZN9Dlg_LoginE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Dlg_Login, qt_meta_tag_ZN9Dlg_LoginE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dlg_Login::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Dlg_LoginE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Dlg_LoginE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9Dlg_LoginE_t>.metaTypes,
    nullptr
} };
...
void *Dlg_Login::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Dlg_LoginE_t>.strings))
