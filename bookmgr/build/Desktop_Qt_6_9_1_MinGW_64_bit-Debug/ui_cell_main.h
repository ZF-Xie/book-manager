...
public:
    ...
    void setupUi(QMainWindow *Cell_Main)
    {
        ...
        centralwidget->setStyleSheet(QString::fromUtf8("QWidget#tool {background:rgb(84,92,100);}\n"
"QWidget#tool QToolButton{background:rgb(84,92,100);color:white;min-height:55px;font:14px\"\346\245\267\344\275\223\";padding-left:12px;}\n"
...
"QStackedWidget#stackedWidget{background-color:white;}"));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/tool.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        btn_record->setToolButtonStyle(Qt::ToolButtonStyle::ToolButtonTextBesideIcon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/\350\277\224\345\233\236.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
